package yzl.swu.yyreader.remote.packages;
...
public class BookChapterPackage{
    ...
    public static class MixTocBean {
        ...
        private List<TxtChapterModel> chapters;
        ...
        public List<TxtChapterModel> getChapters() {
            return chapters;
        }

        public void setChapters(List<TxtChapterModel> chapters) {
