...
public class EasyRatingBar extends View {
    ...
    private void initAttrs(AttributeSet attrs){
        ...
        mInterval = (int) a.getDimension(R.styleable.EasyRatingBar_rateInterval,Utils.dpToPx(mContext,4));
    ...
    private int getInitRoomHeight(){
        ...
        return Math.min(Utils.dpToPx(mContext,DEFAULT_MAX_HEIGHT),drawableMin);
    }
